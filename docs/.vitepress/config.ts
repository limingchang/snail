    ...
    nav: [
      {
        ...
        items: [
          ...
          { text: "插件系统", link: "/guide/plugins", activeMatch: "/guide/" },
          {
            text: "请求策略",
            link: "/guide/strategies",
            activeMatch: "/guide/",
          },
          { text: "API参考", link: "/guide/reference", activeMatch: "/api/" },
          {
            text: "请求库示例",
            link: "/examples/crud",
      ...
      },
      {
        ...
        items: [
          ...
          { text: "工具栏", link: "/editor/tools", activeMatch: "/editor/" },
          {
            text: "组件接口",
      ...
      },
      {
        text:"组件库",
        items:[
          { text: "图标", link: "/vue/#sicon" , activeMatch: "/vue/"},
          { text: "图标集", link: "/vue/#图标集", activeMatch: "/vue/" },
          { text: "点击复制", link: "/vue/#sclickcopy" , activeMatch: "/vue/"},
          { text: "阿里验证码", link: "/vue/#alicaptcha" , activeMatch: "/vue/"},
          { text: "弹出菜单", link: "/vue/#spopupmenu" , activeMatch: "/vue/"},
          { text: "词云", link: "/vue/#swordcloud" , activeMatch: "/vue/"},
        ]
      },
      {
        text:"Cli[测试中,未发布]",
        items:[
          { text: "总览", link: "/cli/", activeMatch: "/cli/" },
            { text: "安装", link: "/cli/#安装" , activeMatch: "/cli/"},
            { text: "snail init", link: "/cli/#snail-init", activeMatch: "/cli/" },
            { text: "snail generate", link: "/cli/#snail-generate" , activeMatch: "/cli/"},
            { text: "生成的文件结构", link: "/cli/#生成的文件结构" , activeMatch: "/cli/"},
            { text: "确定性保证", link: "/cli/#确定性保证", activeMatch: "/cli/" },
            { text: "程序化 API", link: "/cli/#程序化-api" , activeMatch: "/cli/"},
            { text: "已知限制", link: "/cli/#已知限制" , activeMatch: "/cli/"},
        ]
      },
    ],
      ...
      "/guide/": [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "插件生命周期（English）",
              link: "/guide/plugin-lifecycle_EN",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "useAutoRequest",
              link: "/guide/strategies/use-auto-request",
            },
            {
              text: "useRetriableRequest",
              link: "/guide/strategies/use-retriable-request",
            },
      ...
      "/editor/": [
        {
          ...
          items: [
            { text: "总览", link: "/editor/introduction" },
            { text: "快速开始", link: "/editor/getting-start" },
            { text: "两种模式", link: "/editor/two-mode" },
            { text: "模板来源与保存", link: "/editor/template" },
          ],
        },
        {
          text: "内置扩展",
          items: [
            { text: "变量", link: "/editor/extensions" },
            {
              text: "页眉页脚与页码",
              link: "/editor/extensions/#页眉页脚与页码",
            },
            { text: "水印", link: "/editor/extensions/#水印" },
            { text: "打印", link: "/editor/extensions/#打印" },
          ],
        },
        {
          text: "工具栏",
          items: [{ text: "工具栏分组", link: "/editor/tools" }],
        },
        {
          text: "接口",
          items: [
            { text: "组件接口", link: "/editor/interface" },
            {
              text: "已知的清晰边界",
              link: "/editor/interface/#已知的清晰边界",
            },
          ],
        },
      ],
