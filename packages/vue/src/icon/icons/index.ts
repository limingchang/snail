...
import PageOrientation from "./PageOrientation.vue";
...
export const IconNewPage = install(NewPage);
export const IconPageMargin = install(PageMargin);
export const IconPageOrientation = install(PageOrientation);
export const IconPageSize = install(PageSize);
